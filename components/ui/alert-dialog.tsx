...
interface AlertDialogActionProps extends AlertDialogPrimitive.ActionProps {
  loading?: boolean;
}
...
>(({ className, loading, disabled, ...props }, ref) => (
  <TextClassContext.Provider
    value={{ textClass: buttonTextVariants({ className }), loading: loading }}
  >
...
interface AlertDialogCancelProps extends AlertDialogPrimitive.CancelProps {
  loading?: boolean;
}
...
>(({ className, loading, disabled, ...props }, ref) => (
  <TextClassContext.Provider
    value={{
      textClass: buttonTextVariants({ className, variant: 'outline' }),
      loading: loading,
    }}
  >
